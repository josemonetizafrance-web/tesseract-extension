...
<div class="ml-foot">
  ...
  document.getElementById('mlExecuteBtn').addEventListener('click', executeMailingFromPanel);
...
function updateExecuteButtonState() {
  ...
  document.getElementById('mlExecuteBtn').style.display = isActive ? 'none' : '';
...
async function executeMailingFromPanel() {
  const infoEl = document.getElementById('mlInfoMsg');
  const errEl = document.getElementById('mlErrorMsg');
  errEl.style.display = 'none';
  infoEl.style.display = 'none';
  ...
  document.getElementById('mlExecuteBtn').disabled = true;
  document.getElementById('mlExecuteBtn').textContent = 'ENVIANDO...';
  updateExecuteButtonState();
